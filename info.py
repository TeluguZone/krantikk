...
START_MESSAGE = environ.get('START_MESSAGE','👋 𝙷𝙴𝙻𝙾 {user}\n\n𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 {bot},\n𝙸 𝙲𝙰𝙽 𝙿𝚁𝙾𝚅𝙸𝙳𝙴 STUFF, 𝙹𝚄𝚂𝚃 𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙼𝙴 𝙰𝙳𝙼𝙸𝙽...')
...
# url shortner
SHORT_URL = environ.get("SHORT_URL",'https://atglinks.com')
SHORT_API = environ.get("SHORT_API",'d55fdff25071b1d5137112106f79a39d27230f25')
