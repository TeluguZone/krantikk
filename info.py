...
START_MESSAGE = environ.get('START_MESSAGE','Hello {mention}⚡️... I'm Stuff provider bot ... For Desi, Search As "Desi"... For Foreign, Search As "Foreign" ❤ Without ads stuff ki access kavali ante membership tisuko mava per month just 20rs a. For access contact me @STUFF_ACCESS_BOT ,slots will open every month 25th to 1th only.')
